...
const [iotDistribution, setIotDistribution] = useState({
 ...
 const fetchDashboardData = async () => {
  try {
    const response = await fetch("http://172.28.40.165:3000/api/dashboard");
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F8F7FC' }}>
      <ScrollView
        contentContainerStyle={{
          ...
          paddingTop: 20,
          paddingBottom: 60, // laisse de l'espace en bas pour la barre de navigation
...
const styles = StyleSheet.create({
  ...
  statIconPrimary: { backgroundColor: 'rgba(139, 92, 246, 0.1)' },
  statIconDanger: { backgroundColor: 'rgba(239, 68, 68, 0.1)' },
  statIconSuccess: { backgroundColor: 'rgba(16, 185, 129, 0.1)' },
  statIconWarning: { backgroundColor: 'rgba(245, 158, 11, 0.1)' },
  iconText: { fontSize: 20 },
  statValue: { fontSize: 36, fontWeight: '700', color: '#111827', marginBottom: 8 },
  statChange: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  statChangeText: { fontSize: 13, fontWeight: '500' },
  ...
  chartTitle: { fontSize: 20, fontWeight: '600', color: '#111827', marginBottom: 12 },
  chartFilters: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  filterBtn: { paddingVertical: 8, paddingHorizontal: 16, borderWidth: 1, borderColor: '#E5E7EB', backgroundColor: '#FFFFFF', borderRadius: 8 },
  filterBtnActive: { backgroundColor: '#8B5CF6', borderColor: '#8B5CF6' },
  filterBtnText: { fontSize: 13, color: '#6B7280', fontWeight: '500' },
  filterBtnTextActive: { color: '#FFFFFF' },
  chartPlaceholder: { height: 280, backgroundColor: 'rgba(139, 92, 246, 0.05)', borderRadius: 12, justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
  chartBars: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-around', height: '100%', width: '100%', paddingHorizontal: 20, paddingVertical: 20 },
  chartBar: { flex: 1, marginHorizontal: 4, backgroundColor: '#d75cf6', borderTopLeftRadius: 8, borderTopRightRadius: 8 },
  donutChart: { width: 200, height: 200, borderRadius: 100, borderWidth: 40, borderColor: '#8B5CF6', alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent' },
  donutValue: { fontSize: 28, fontWeight: '700', color: '#111827' },
  donutLabel: { fontSize: 12, color: '#6B7280' },
  energyStats: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 20 },
  ...
  energyStatValue: { fontSize: 20, fontWeight: '600' },
  energyStatValuePrimary: { color: '#8B5CF6' },
  energyStatValueSuccess: { color: '#10B981' },
  energyStatValueWarning: { color: '#F59E0B' },
});
