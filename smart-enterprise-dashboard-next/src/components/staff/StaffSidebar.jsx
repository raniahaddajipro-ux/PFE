// src/components/staff/Staffsidebar.jsx - FIXED VERSION
import { useState } from 'react';

const Staffsidebar = ({ currentPage, onNavigate, userName, currentUser, onLogout }) => {
  const [isMobileOpen, setIsMobileOpen] = useState(false);

  const userAvatar = userName ? userName.charAt(0).toUpperCase() : 'X';
